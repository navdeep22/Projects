      ...
      body: SafeArea(
        child: StreamBuilder<bool>(
          ...
          builder: (BuildContext context, AsyncSnapshot<bool> snapshot) {
            ...
            if (_addOnsBloc.tableCart != null &&
                _addOnsBloc.tableCart.isNotEmpty) {
              for (var each in _addOnsBloc.tableCart) {
                total = total + double.parse(each.rate.toString());
                print("table------ > $total");
                if (each.addons != null && each.addons.isNotEmpty) {
                  for (var item in each.addons) {
                    total = total + double.parse(item.rate.toString());
                    print("table addon------ > $total");
                  }
                }
              }
            }
            if (_addOnsBloc.eventCart != null &&
                _addOnsBloc.eventCart.isNotEmpty) {
              for (var each in _addOnsBloc.eventCart) {
                total = total + double.parse(each.rate.toString());
                print("event------ > $total");
                if (each.addons != null && each.addons.isNotEmpty) {
                  for (var item in each.addons) {
                    total = total + double.parse(item.rate.toString());
                    print("event addon------ > $total");
                  }
                }
              }
            }
        ...
        child: Dismissible(
          ...
          onDismissed: (direction) {
            setState(() {
              ...
              _addOnsBloc.deleteTable(_addOnsBloc.tableCart[index].id, context);
              // Timer(Duration(seconds: 5), () {
              //   print("------------table deleted---------");
              //   fetchAddOns();
              //   Timer(Duration(seconds: 1), () {
              //     setState(() {
              //       _addOnsBloc.tableCart = _addOnsBloc.tableCart ?? "";
              //       print("-----tables list------  $_addOnsBloc.tableCart");
                                            ...
                                            Expanded(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  Text(
                                                    'Price: ${_addOnsBloc.tableCart[index].addons[i].rate}', // ${tableModel.currency}',
                                                    maxLines: 2,
                                                    style: Theme.of(context)
                                                        .textTheme
                                                        .bodyText2
            ...
            Expanded(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    // "52898",
                    'Price: ${_addOnsBloc.tableCart[index].rate}', // ${tableModel.currency}',
                    maxLines: 2,
                    style: Theme.of(context)
                        .textTheme
                        .bodyText2
                  ...
                  Text(
                    // "10/50/22",
                    'Booking on: ' +
                        _addOnsBloc.tableCart[index].date.toString(),
                    maxLines: 2,
                    style: Theme.of(context)
                        .textTheme
                        .bodyText2
                                                ...
                                                Expanded(
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      Text(
                                                        'Price: ${_addOnsBloc.eventCart[index].addons[i].rate}', // ${tableModel.currency}',
                                                        maxLines: 2,
                                                        style: Theme.of(context)
                                                            .textTheme
                                                            .bodyText2
            ...
            Expanded(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    // "52898",
                    'Price: ${_addOnsBloc.eventCart[index].rate}', // ${tableModel.currency}',
                    maxLines: 2,
                    style: Theme.of(context)
                        .textTheme
                        .bodyText2
                  ...
                  Text(
                    // "10/50/22",
                    'Booking on: ' +
                        _addOnsBloc.eventCart[index].date.toString(),
                    maxLines: 2,
                    style: Theme.of(context)
                        .textTheme
                        .bodyText2
            ...
            Expanded(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Price: ${addOnModel.cost} ${addOnModel.currency}',
                    maxLines: 2,
                    style: Theme.of(context)
                        .textTheme
                        .bodyText2
                  ...
                  children: [
                    Text('Total',
                        style: Theme.of(context)
                            ...
                            .subtitle1
                            .apply(color: textColorDarkPrimary)),
                    Text('${ClubApp.currencyLbl} ' + total.toStringAsFixed(2),
                        style: Theme.of(context)
                            .textTheme
                            .bodyText1
                            .apply(color: textColorDarkPrimary)),
              ...
              Row(
                ...
                children: [
                  OutlineBorderButton(
                    ...
                    if (total > 0) {
                      print("total from table cart ----------  $total");
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => Checkout(total)));
                    } else {
