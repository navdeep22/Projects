            ...
            return ModalProgressHUD(
              ...
              child: Column(
                ...
                children: [
                  ...
                  (_biddingBloc.biddingList != null && _biddingBloc.biddingList.isNotEmpty)
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: Theme.of(context)
                          .textTheme
                          .caption
                          .copyWith(color: textColorDarkSecondary, fontSize: 12),
                    ),
                    const SizedBox(
                      height: 2,
                    ),
                    Text(
                      ...
                      style: Theme.of(context)
                          .textTheme
                          .bodyText2
                          .copyWith(color: textColorDarkSecondary, fontSize: 13),
                    ),
                  ],
                ),
              ),
      ...
      children: [
        Text(bidderName + " : ",
            style: Theme.of(context)
                ...
                .caption
                .apply(color: textColorDarkPrimary)),
        Text("$bidAmount ${biddingModel.currency}",
            style: Theme.of(context)
                .textTheme
                .bodyText2
                .apply(color: textColorDarkPrimary)),
