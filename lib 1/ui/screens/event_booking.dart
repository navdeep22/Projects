        ...
        leading: IconButton(
          onPressed: () {
            Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => EventDetailsScreen(eventModel)));
                        ...
                        child: StreamBuilder<EventsBookingState>(
                          ...
                          builder: (BuildContext context,
                            ...
                            if (snapshot.data ==
                              ...
                              eventSeatsList = _eventBookingBloc.eventSeatsList;
                  ...
                  IntrinsicHeight(
                    child: Row(
                      ...
                      children: [
                        ...
                        Text(
                          'Remaining: ${eventSeats.remaining}',
                          maxLines: 2,
                          style: Theme.of(context)
                              .textTheme
                              .bodyText2
                      ...
                      GestureDetector(
                        ...
                        onTap: () {
                          ...
                          if (eventSeats.remaining < 1) {
                            Utility.showSnackBarMessage(
                                _scaffoldKey, ClubApp.seats_capacity_reached);
                          } else {
                            setState(() {
                              eventSeats.quantity += 1;
                              totalAmount += eventSeats.rate;
