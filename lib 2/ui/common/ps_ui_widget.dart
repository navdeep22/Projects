...
class PsNetworkImage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    if (defaultPhoto.imgPath == '') {
      ...
      if (imageAspectRation == PsConst.Aspect_Ratio_1x) {
        thumbnailImagePath =
            '${PsConfig.ps_app_image_thumbs_url}${defaultPhoto.imgPath}';
      } else if (imageAspectRation == PsConst.Aspect_Ratio_2x) {
        thumbnailImagePath =
            '${PsConfig.ps_app_image_thumbs_2x_url}${defaultPhoto.imgPath}';
      } else if (imageAspectRation == PsConst.Aspect_Ratio_3x) {
        thumbnailImagePath =
            '${PsConfig.ps_app_image_thumbs_3x_url}${defaultPhoto.imgPath}';
      } else {
        thumbnailImagePath =
            '${PsConfig.ps_app_image_url}${defaultPhoto.imgPath}';
      }
...
class PsNetworkImageWithUrl extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    if (imagePath == '') {
      ...
      String thumbnailImagePath;
      if (imageAspectRation == PsConst.Aspect_Ratio_1x) {
        thumbnailImagePath = '${PsConfig.ps_app_image_thumbs_url}$imagePath';
      } else if (imageAspectRation == PsConst.Aspect_Ratio_2x) {
        thumbnailImagePath = '${PsConfig.ps_app_image_thumbs_2x_url}$imagePath';
      } else if (imageAspectRation == PsConst.Aspect_Ratio_3x) {
        thumbnailImagePath = '${PsConfig.ps_app_image_thumbs_3x_url}$imagePath';
      } else {
        thumbnailImagePath = '${PsConfig.ps_app_image_url}$imagePath';
      }
