...
import 'package:flutterbuyandsell/ui/vender_screens/vender_login.dart';
        ...
        return AnimatedBuilder(
          ...
          child: Column(
            children: <Widget>[
              ...
              _LoginAsVender(userProvider: provider),
              const SizedBox(
                height: PsDimens.space8,
              ),
...
class _LoginAsVender extends StatefulWidget {
  const _LoginAsVender({@required this.userProvider});
  final UserProvider userProvider;

  @override
  __LoginAsVenderState createState() => __LoginAsVenderState();
}

class __LoginAsVenderState extends State<_LoginAsVender> {
  @override
  Widget build(BuildContext context) {
    return Container(
        margin: const EdgeInsets.only(
        ...
        child: PSButtonWithIconWidget(
          titleText: Utils.getString(context, 'login__vender'),
          ...
          onPressed: () async {
            ...
            Navigator.push(
                ...
                MaterialPageRoute<void>(
                    builder: (BuildContext context) => VenderLogin()));
          },
        ));
  }
}
