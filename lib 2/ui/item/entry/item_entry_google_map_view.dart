...
// class ItemEntryGoogleMapView extends StatefulWidget {
//   const ItemEntryGoogleMapView(
...
// class _ItemEntryViewState extends State<ItemEntryGoogleMapView> {
...
//   dynamic updateMapController(GoogleMapController mapController){
...
//       kGooglePlex = CameraPosition(
//         target: LatLng(double.parse(itemEntryProvider.item.lat),
//           double.parse(itemEntryProvider.item.lng)),
//         zoom: widget.zoom,
//       ); 
//     }
...
//                     zoom: widget.zoom);
//                 if(_kLake != null) {
//                   widget.googleMapController.animateCamera(CameraUpdate.newCameraPosition(_kLake));
...
//                 circles: <Circle> {}
//                     ..add(Circle(
//                       circleId: CircleId(widget.userInputAddress.toString()),
//                       center: _latlng,
//                       radius: 50,
...
//                   FocusScope.of(context).requestFocus(FocusNode());
//                   _handleTap(_latlng, widget.googleMapController);
//               }),
//           ),     
//         ),
//       PsTextFieldWidget(
...
//   dynamic _handleTap(LatLng latLng, GoogleMapController googleMapController) async {
//     final dynamic result = await Navigator.pushNamed(context, RoutePaths.googleMapPin,
...
//   // final MapController googleMapController = MapController();
