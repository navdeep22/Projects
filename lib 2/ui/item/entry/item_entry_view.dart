                      ...
                      Consumer<GalleryProvider>(builder: (BuildContext context,
                        ...
                        if (provider != null &&
                          ...
                          for (int imageId = 0;
                              ...
                              imageId++) {
                            if (imageId == 0 &&  provider.galleryList.data[imageId] != null &&
                                provider.galleryList.data[imageId].imgId != null) {
                              _itemEntryProvider.firstImageId =
                                  provider.galleryList.data[imageId].imgId;
                            }
                            if (imageId == 1 &&  provider.galleryList.data[imageId] != null &&
                                provider.galleryList.data[imageId].imgId != null) {
                              _itemEntryProvider.secondImageId =
                                  provider.galleryList.data[imageId].imgId;
                            }
                            if (imageId == 2 &&  provider.galleryList.data[imageId] != null &&
                                provider.galleryList.data[imageId].imgId != null) {
                              _itemEntryProvider.thirdImageId =
                                  provider.galleryList.data[imageId].imgId;
                            }
                            if (imageId == 3 &&  provider.galleryList.data[imageId] != null &&
                                provider.galleryList.data[imageId].imgId != null) {
                              _itemEntryProvider.fourthImageId =
                                  provider.galleryList.data[imageId].imgId;
                            }
                            if (imageId == 4 &&  provider.galleryList.data[imageId] != null &&
                                provider.galleryList.data[imageId].imgId != null) {
                              _itemEntryProvider.fiveImageId =
                                  provider.galleryList.data[imageId].imgId;
                            }
